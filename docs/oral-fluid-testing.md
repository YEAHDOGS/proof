...
user's standing ask this brief answers: *"the shift from urine to oral-fluid
...
3. **Safety-sensitive jobs feel the strictest edge.** DOT-regulated and other
   ...
   when urine never would have caught it. That is the employment hook user
   ...
   looser.
4. **The job-search angle.** user links his own difficulty getting hired to
